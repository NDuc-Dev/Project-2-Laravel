    <div class="modal fade" id="form-focus" tabindex="-1" role="dialog" aria-labelledby="form-login-focus" aria-hidden="true"
        id="dialog">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    Login
                    <h5 class="modal-title" id="form-login-focus"></h5>
                            ...
                            <form method="POST" action="{{ route('login') }}" class="signin-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="Name" data-error="Vui lòng nhập tên" data-success="Tên hợp lệ">
                                </div>
                                <div class="form-group">

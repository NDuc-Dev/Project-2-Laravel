        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="{{ asset($product->product_images) }}" class="image-popup"><img
                            src="{{ asset($product->product_images) }}" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    <h3>{{ $product->product_name }}</h3>
                    <p class="price"><span id="priceSpan"></span></p>

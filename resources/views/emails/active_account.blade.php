                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                                style="line-height: 39.2px; font-size: 28px;">Active Your Account </span></strong>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;"><span
                                                                        style="font-size: 22px; line-height: 35.2px;">Hi, {{$user->name}}
                                                                    </span></p>
                                                                <p style="font-size: 14px; line-height: 160%;"><span
                                                                        ...
                                                                        enjoy exclusive services with us!
                                                                    </span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div align="center">
                                                                ...
                                                                <a  href="{{route('actived_account', ['user'=> $user->user_id, 'token'=> $user->token])}}" target="_blank" class="v-button"
